...
#define STATE_PATH_TPL           "/tmp/nex%s_%i_%i-state"
...
#define NEX_CLASS_NAME    "Bspwm"
#define META_WINDOW_IC      "wm\0" NEX_CLASS_NAME
#define ROOT_WINDOW_IC      "root\0" NEX_CLASS_NAME
#define PRESEL_FEEDBACK_I   "presel_feedback"
#define PRESEL_FEEDBACK_IC  PRESEL_FEEDBACK_I "\0" NEX_CLASS_NAME
#define MOTION_RECORDER_I   "motion_recorder"
#define MOTION_RECORDER_IC  MOTION_RECORDER_I "\0" NEX_CLASS_NAME
