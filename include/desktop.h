...
//--------------------------------------------------------includes 
// include the "types.h" in which monitor_t, desktop_t, and serveral other types are defined. 
#include "types.h"

//--------------------------------------------------------define macros.
// when there is an empty window, like no window at all, we name it desktop.
